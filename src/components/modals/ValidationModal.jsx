        ...
        <div className="flex-1 overflow-y-auto p-6 bg-slate-50">
          {warnings.length === 0 ? (
            ...
            <div className="space-y-3">
              <div className="mb-4 text-sm text-slate-600 bg-white p-3 rounded border border-slate-200 shadow-sm flex items-center justify-between">
                <span>合計 <strong>{warnings.length}</strong> 件の警告が見つかりました。職員名をクリックして個別に修正してください。</span>
              </div>
