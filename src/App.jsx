...
export const AppContent = () => {
  ...
  return (
    ...
    >
      ...
      <ValidationModal isOpen={modals.validation.isOpen} onClose={() => closeModal('validation')} employees={employees} targetYear={targetYear} onEmpClick={(empId) => { const emp = employees.find(e => e.id === empId); if (emp) openModal('emp', emp); }} />
