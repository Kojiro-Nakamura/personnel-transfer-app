...
<head>
  ...
  <style>
    ...
    table { border-collapse: collapse; table-layout: fixed; width: 100%; min-width: 1150px; border: 2px solid #334155; }
    ...
    td:nth-child(4), td:nth-child(10), td:nth-child(16) { border-left: 2px solid #334155; } 
    thead tr:nth-child(2) th:nth-child(4), thead tr:nth-child(2) th:nth-child(5), thead tr:nth-child(2) th:nth-child(6) { border-left: 2px solid #334155 !important; }
    thead tr:nth-child(3) th:nth-child(1), thead tr:nth-child(3) th:nth-child(7) { border-left: 2px solid #334155 !important; } 
    ...
    tr.border-dept-top td { border-top: 2px solid #334155 !important; }
      ...
      const updateBorders = () => {
        ...
        rows.forEach(row => {
          ...
          if (row.style.display !== 'none') {
            ...
            for(let i = 0; i < row.cells.length; i++) {
              ...
              if (isNewDept) {
                cell.style.borderTop = '2px solid #334155';
              } else if (isNewGroup) {
        ...
        if (visibleRows.length > 0) {
          ...
          for(let i = 0; i < lastRow.cells.length; i++) {
            lastRow.cells[i].style.borderBottom = '2px solid #334155';
          }
        }
      };
