...
const t = `    td:nth-child(4), td:nth-child(10), thead tr:nth-child(2) th:nth-child(1), thead tr:nth-child(2) th:nth-child(7) { width: 50px; max-width: 50px; word-break: break-word; }`;
...
console.log("Patched HTML export CSS to set notes width to 50px");
