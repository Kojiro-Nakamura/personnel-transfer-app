...
const regex = /ws\.getCell\(currentRowIndex, 1\)\.value = '令和' \+ \(targetYear - 2019\) \+ '年度林学職生年別一覧';\s*ws\.getCell\(currentRowIndex, 1\)\.font = titleFont;/;
...
if (regex.test(code)) {
  code = code.replace(regex, legendInsertion);
