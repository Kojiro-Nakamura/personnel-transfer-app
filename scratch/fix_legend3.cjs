...
// 1. horizontalCentered
code = code.replace(
  /pageSetup: \{ paperSize: 9, orientation: 'landscape', fitToPage: true/,
  "pageSetup: { paperSize: 9, orientation: 'landscape', horizontalCentered: true, fitToPage: true"
);

// 2. Legend label and row gap
const oldLegendBlock = `  // Legend
  const legendLabels = [
