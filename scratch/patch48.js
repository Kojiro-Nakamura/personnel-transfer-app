...
const t = `td:nth-child(5), td:nth-child(11), thead tr:nth-child(2) th:nth-child(2), thead tr:nth-child(2) th:nth-child(8) { white-space: nowrap; min-width: 74px; }`;
const r = `td:nth-child(5), td:nth-child(11), thead tr:nth-child(2) th:nth-child(2), thead tr:nth-child(2) th:nth-child(8) { white-space: nowrap; min-width: 63px; }`;
...
console.log("Patched HTML export CSS to narrow name column by one more character");
