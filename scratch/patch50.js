...
const t = `    td:nth-child(5), td:nth-child(11), thead tr:nth-child(2) th:nth-child(2), thead tr:nth-child(2) th:nth-child(8) { white-space: nowrap; width: 70px; min-width: 70px; max-width: 70px; overflow: hidden; text-overflow: ellipsis; padding-left: 2px; padding-right: 2px; text-align: center; }`;
...
console.log("Patched HTML export CSS to narrow department column");
