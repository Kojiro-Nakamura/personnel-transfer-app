...
const prefixIdx = content.indexOf('export const parseJapaneseDate');
const suffixIdx = content.indexOf('export const parseCSVRow');
...
`;
  fs.writeFileSync(file, prefix + newFunc + suffix, 'utf8');
}
